...
._backButton_1r7ri_10 {
  align-self: flex-start;
  margin-bottom: 16px;
  padding: 8px 16px;
  background: transparent;
  color: #097fb3;
  border: 1px solid #097fb3;
  border-radius: 6px;
  font-size: 14px;
  font-weight: 500;
  cursor: pointer;
...
._backButton_1r7ri_10:hover {
  background: #097fb3;
  color: white;
}

._propertyDetailsContainer_1r7ri_29 {
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: 48px;
  max-width: 1200px;
...
._propertyImageSection_1r7ri_38 {
  position: relative;
  display: flex;
  flex-direction: column;
}

._propertyImageContainer_1r7ri_44 {
  width: 100%;
  background: #f5f5f5;
  display: flex;
  align-items: center;
...
._propertyImageContainer_1r7ri_44 img {
  width: 100%;
  height: auto;
  max-height: 400px;
  object-fit: cover;
...
._propertyInfoSection_1r7ri_75 {
  display: flex;
  flex-direction: column;
  gap: 16px;
}

._propertyCategory_1r7ri_81 {
  font-size: 12px;
  color: #666;
  text-transform: uppercase;
  letter-spacing: 0.5px;
...
._propertyShortDescription_1r7ri_103 {
  font-size: 16px;
  color: #666;
  line-height: 1.5;
  margin: 0;
...
._actionButtons_1r7ri_110 {
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
}

._viewOnSiteButton_1r7ri_116 {
  padding: 14px 24px;
  background-color: #097fb3;
  color: white;
  border: none;
...
._viewOnSiteButton_1r7ri_116:hover:not(:disabled) {
  background-color: #076a94;
}

._viewOnSiteButton_1r7ri_116:disabled {
  background-color: #ccc;
  cursor: not-allowed;
}

._scheduleConsultationButton_1r7ri_137 {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  padding: 14px 24px;
...
._scheduleConsultationButton_1r7ri_137:hover {
  background-color: #097fb3;
  color: white;
}

._scheduleIcon_1r7ri_157 {
  font-size: 16px;
}

/* Single-page sections */
._pageSections_1r7ri_162 {
  max-width: 1200px;
  margin: 0 auto;
  width: 100%;
  padding-top: 40px;
...
._pageSection_1r7ri_162 {
  margin-bottom: 48px;
  padding-bottom: 48px;
  border-bottom: 1px solid #e8ecf0;
}

._pageSection_1r7ri_162:last-child {
  margin-bottom: 0;
  padding-bottom: 0;
  border-bottom: none;
}

._sectionTitle_1r7ri_181 {
  font-size: 18px;
  font-weight: 600;
  color: #333;
  margin: 0 0 16px 0;
...
._longDescriptionContent_1r7ri_190 {
  font-size: 14px;
  line-height: 1.7;
  color: #444;
}

._longDescriptionParagraph_1r7ri_196 {
  margin: 0 0 0.5em 0;
}

._longDescriptionParagraph_1r7ri_196:last-child {
  margin-bottom: 0;
}

._staticNote_1r7ri_204 {
  margin-top: 16px;
  font-size: 13px;
  color: #666;
  line-height: 1.5;
...
._mapIframe_1r7ri_219 {
  display: block;
}

._locationSection_1r7ri_223 {
  display: flex;
  flex-direction: column;
  gap: 12px;
  margin-top: 16px;
...
._viewOnMapLink_1r7ri_237:hover {
  text-decoration: underline;
}

/* Section images */
._sectionImageWrapper_1r7ri_249 {
  width: 100%;
  background: #f5f5f5;
  border-radius: 8px;
  overflow: hidden;
...
/* Payment plan table */
._paymentPlanTableWrapper_1r7ri_284 {
  width: 100%;
  overflow-x: auto;
  margin-bottom: 16px;
}

._paymentPlanTable_1r7ri_284 {
  width: 100%;
  border-collapse: collapse;
  font-size: 14px;
}

._paymentPlanTable_1r7ri_284 th,
._paymentPlanTable_1r7ri_284 td {
  padding: 12px 16px;
  text-align: left;
...
._paymentPlanTable_1r7ri_284 tbody tr:hover {
  background: #fafbfc;
}
...
const PROPERTY_DETAILS_REQUESTED = "adaptive-website-property-details-requested";
function dispatchPropertyDetailsRequested(property) {
  window.dispatchEvent(
    new CustomEvent(PROPERTY_DETAILS_REQUESTED, {
      detail: { property }
    })
  );
}
...
const ContentZone = ({ show }) => {
  ...
  reactExports.useEffect(() => {
    const handlePropertyDetailsRequested = (event) => {
      ...
      previousContentRef.current = contentRef.current ?? null;
    ...
    window.addEventListener(window.AdaptiveWebsite.Events.ON_EMBEDDED_MESSAGING_LIST_CONVERSATION_ENTRIES, handleListConversationEntries);
    window.addEventListener(PROPERTY_DETAILS_REQUESTED, handlePropertyDetailsRequested);
    return () => {
      window.removeEventListener(window.AdaptiveWebsite.Events.ON_EMBEDDED_MESSAGING_CONTENT_RECEIVED, handleContentReceived);
      window.removeEventListener(window.AdaptiveWebsite.Events.ON_EMBEDDED_MESSAGING_LIST_CONVERSATION_ENTRIES, handleListConversationEntries);
      window.removeEventListener(PROPERTY_DETAILS_REQUESTED, handlePropertyDetailsRequested);
    };
  }, []);
  const handlePropertyDetailsBack = () => {
    setContentZoneContent(previousContentRef.current ?? void 0);
...
function isRealEstatePayload(curation) {
  return Array.isArray(curation) && curation.length > 0 && "personalizations" in curation[0];
}
function extractPropertyItems(curation) {
  var _a, _b;
  const first = curation[0];
  const data = (_b = (_a = first == null ? void 0 : first.personalizations) == null ? void 0 : _a[0]) == null ? void 0 : _b.data;
  return Array.isArray(data) ? data : [];
}
const Recs = ({ content }) => {
  const curation = content == null ? void 0 : content.curation;
  const isRealEstate = curation != null && isRealEstatePayload(curation);
  const properties = isRealEstate ? extractPropertyItems(curation) : [];
  const retailData = !isRealEstate ? curation || {} : null;
  const products = (retailData == null ? void 0 : retailData.products) ?? [];
  const bannerImage = retailData == null ? void 0 : retailData.bannerImage;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.recsTemplate, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.recsProductsGrid, children: isRealEstate ? properties.map((property) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        property,
        onViewMore: dispatchPropertyDetailsRequested
      },
      property.sku
...
const actionButtons$1 = "_actionButtons_19kxk_66";
...
const propertyDetailsTemplate = "_propertyDetailsTemplate_1r7ri_1";
const backButton = "_backButton_1r7ri_10";
const propertyDetailsContainer = "_propertyDetailsContainer_1r7ri_29";
const propertyImageSection = "_propertyImageSection_1r7ri_38";
const propertyImageContainer = "_propertyImageContainer_1r7ri_44";
const propertyBadge = "_propertyBadge_1r7ri_61";
const propertyInfoSection = "_propertyInfoSection_1r7ri_75";
const propertyCategory = "_propertyCategory_1r7ri_81";
const propertyName = "_propertyName_1r7ri_88";
const propertyPrice = "_propertyPrice_1r7ri_96";
const propertyShortDescription = "_propertyShortDescription_1r7ri_103";
const actionButtons = "_actionButtons_1r7ri_110";
const viewOnSiteButton = "_viewOnSiteButton_1r7ri_116";
const scheduleConsultationButton = "_scheduleConsultationButton_1r7ri_137";
const scheduleIcon = "_scheduleIcon_1r7ri_157";
const pageSections = "_pageSections_1r7ri_162";
const pageSection = "_pageSection_1r7ri_162";
const sectionTitle = "_sectionTitle_1r7ri_181";
...
const viewOnMapLink = "_viewOnMapLink_1r7ri_237";
const sectionImageWrapper = "_sectionImageWrapper_1r7ri_249";
const sectionImage = "_sectionImage_1r7ri_249";
const amenitiesList = "_amenitiesList_1r7ri_265";
...
const styles = {
  ...
  amenitiesList,
  amenityChip,
  paymentPlanTableWrapper,
  paymentPlanTable
};
const STATIC_LOCATION = {
  address: "Madinaty City, New Cairo, Egypt",
  lat: 30.0444,
  lng: 31.2357
};
...
const STATIC_PAYMENT_PLAN = [
  { phase: "Down Payment", amount: "10%", percentage: "10%", duration: "On signing" },
  { phase: "Installments", amount: "90%", percentage: "90%", duration: "7 Years" }
];
const STATIC_UNIT_LAYOUT_IMAGE = "https://www.showmyproperty.tv/wp-content/uploads/2023/01/Final-PUR-The-Jones-Unit-2A-scaled.jpg";
const STATIC_MASTER_PLAN_IMAGE = "https://cloud-object-storage-cos-vso.s3.eu-de.cloud-object-storage.appdomain.cloud/assets/assets/imgs/Gallery/Noor/image8.jpeg";
const PropertyDetails = ({ content, onBack }) => {
  const detailsData = (content == null ? void 0 : content.curation) || {};
  const property = detailsData == null ? void 0 : detailsData.property;
  if (!property) {
    return null;
  }
  const formattedPrice = property.price != null && property.currency ? `${property.price.toLocaleString()} ${property.currency}` : property.price != null ? property.price.toLocaleString() : void 0;
  ...
  const handleScheduleConsultation = () => {
    const aw = window.AdaptiveWebsite;
    if (typeof (aw == null ? void 0 : aw.sendTextMessage) === "function") {
      aw.sendTextMessage(`I would like to schedule a consultation for ${property.name}.`);
    }
  };
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles.pageSection, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.paymentPlanTableWrapper, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: styles.paymentPlanTable, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: STATIC_PAYMENT_PLAN.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: row.percentage }),
